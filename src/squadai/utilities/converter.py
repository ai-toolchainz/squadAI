...
class Converter(BaseModel):
    ...
    def _create_instructor(self):
        ...
        from squadai.utilities import Instructor
    ...
    def _create_chain(self):
        """Create a chain."""
        from squadai.utilities.squad_pydantic_output_parser import (
            SquadPydanticOutputParser,
        )

        parser = SquadPydanticOutputParser(pydantic_object=self.model)
