...
from squadai.tools.tool_usage import ToolUsage, ToolUsageErrorException
...
class SquadAgentExecutor(AgentExecutor):
    _i18n: I18N = I18N()
    ...
    def _create_short_term_memory(self, output) -> None:
        if (
            ...
            self.squad._short_term_memory.save(memory)
